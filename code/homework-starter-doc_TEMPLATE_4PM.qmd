...
**plants with larger biomass seem to have larger ranges, Grindelia (gumweed), california poppy, purple needlegrass seem to have highest biomass, Acmispon, purple sage, and scarlet bugler seem to have the lowest biomass**
...
**Slight positive correlation, correlation coefficient of .453. Moderate or strong depending on how you round correlation.**

# Model construction

What is the null model?  

0. **total mass as a function of none of the predictors**  

What is the saturated model?  

1. **total mass predicted by specific leaf area (SLA), water treatment, and species**  
...
Out of the four models we have tried, the best model is the one that includes **all three predictors (specific leaf area, water treatment, and species) (saturated model)**  and delta is zero! Model 1. 
...
- SLA slope: **across drought treatments and species, with each 1 unit increase in SLA (mm^2^/dry mass of leaf), we expect an decrease in total mass of 0.00025 +- 0.0005 (figure out how to display plus minus in doc) WHICH MEANS WITH THE ESTIMATE AND STANDARD ERROR THERE IS NO EFFECT OF SLA ON TOTAL MASS**  
- well watered estimate: **On average, across species and SLA, well watered plants tend to be 0.12 +- (figure out how to write plus minus in text) 0.02 g heavier/more massive than drought stressed plants**    
